            ...
            <div className="w-1/2 h-full flex flex-col gap-14 justify-center max-md:w-full max-md:gap-5 max-md:px-12">
              ...
              <div className=" mr-28 max-md:mr-0">
                <p className=" dark:text-white text-blue-900 text-lg max-md:text-base">
                  ...
                  or cubicle for each person, separate floors for each
                  department , a nice lobby, and a canteen? Or the more modern
                  approach, multiple settings for different types of work
                  blended with meeting rooms for various types of meetings?
                </p>
              </div>
            </div>
          </div>
