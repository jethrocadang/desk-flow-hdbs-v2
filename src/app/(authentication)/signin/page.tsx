  ...
  return (
    <div>
      <div className='max-md:relative bg-white h-screen w-full '>
        {/* background Image */}
        <Image src={bgImagaAuth} className='hidden md:flex md:h-screen md:w-full md:bg-cover md:bg-center md:relative' alt="" />
              ...
              <div className=' w-full md:mx-10 z-10'>
                ...
                <div className='flex gap-5'>
                  <div className='flex flex-col gap-5'>
                    <h1 className="text-2xl text-blue-700 font-bold ">Desk<span className='text-blue-500'>Flow</span> </h1>
                    <h2 className='text-4xl text-blue-700 font-bold '>Welcome back!</h2>
                    <p className='text-xs text-slate-400'>If you are already a user, you can login with your email and password.</p>
                  </div>
                ...
                <span className='text-black text-xs'>Not registered yet?</span><Link href="/" className='text-xs text-blue-900 hover:text-blue-500 font-semibold'>Create an account</Link>
                </div>
              </div>
            </div>
